	...
	if(i==1){
		...
		anchorBody=(Body)Data.arrayPosCheesArray.get(MathUtils.random(Data.arrayPosCheesArray.size-1)).getUserObject();
		 ...
		 DistanceJointDef jointDef3 = new DistanceJointDef();
		    ...
		    if(Data.level==State.LEVEL_1) jointDef3.frequencyHz=0.15f;//���� ���������� � �������
		    if(Data.level==State.LEVEL_2) jointDef3.frequencyHz=0.2f;//���� ���������� � �������
		    if(Data.level==State.LEVEL_3) jointDef3.frequencyHz=0.25f;//���� ���������� � �������
